...
m1 <- feols(
  data = joined_data,
  cattle_heads_big/area_amc ~ sw(1, si_mean + ma_norm + I(pasture/area_amc*100)) | csw(1,main_biome,code_state) | local_price + local_price_2 ~ ssiv + ssiv_2,
...
feols(
  ...
  y ~  main_biome:x2 + ma_norm | main_biome,
  cluster = "code_amc"
  ) |> 
  etable()
```
...
ext_ppm <- cattle_heads_ppm |> 
  ...
  mutate(
    ...
    x1 = 0.45*(cattle_heads**2)/10000000,
