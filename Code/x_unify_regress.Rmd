...
joined_data <- left_join(
  ...
  mutate(
    ...
    # Deflated using ratio (index_2022/index)
  ...
  mutate(
    biomass_density = biomass/area_amc
  )
```
...
feols(
  ...
  + area_amc
  + ma_norm
  # + (si_q1_mean + si_q2_mean + si_q3_mean)
  + si_q4_mean
  + high_share:main_biome
  + year
  + biomass
...
feols(
  ...
  etable(fitstat = ~ n + f + f.p + wf + wf.p)
```
