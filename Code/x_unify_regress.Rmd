...
ggsave("../Outputs/Graphics/map_quality", plot = map_quality, device = "pdf", width = 10, height = 6)
```
...
ggsave("../Outputs/Graphics/map_biomass", plot = map_biomass, device = "pdf", width = 8, height = 8)
```
...
ggsave("../Outputs/Graphics/plot_ch", plot = plot_ch, device = "pdf", width = 10, height = 6)
```
